const Section2 = () => {
    return (
      <section className="py-12 w-full max-w-[1230px] px-[15px] mx-auto flex lg:flex-col">
        <div className="w-7/12 overflow-hidden shadow-sm lg:w-full lg:h-80 lg:order-2">
          <img src="/img/LeSpa.jpg" alt="Section 2" className="object-cover w-full lg:h-full" />
        </div>
        <div className="relative flex-1 lg:order-1">
          <div className="absolute lg:relative lg:top-0 lg:left-0 lg:w-full top-[20%] w-[90%] left-[-20px] px-[50px] pt-[30px] pb-10 bg-white shadow-2xl z-10 flex flex-col gap-3">
